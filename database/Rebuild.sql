-- -----------------------------------------------------
-- 1. CLEAN UP (Drops existing objects so we can rebuild)
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- 2. CREATE TYPE & TABLES
-- -----------------------------------------------------

-- Create ENUM Type for Account
CREATE TYPE public.account_type AS ENUM
    ('Client', 'Employee', 'Admin');

-- Note: The OWNER statement is optional depending on your setup. 
-- If 'cse340' user doesn't exist, this might fail. 
-- Safe to leave out for general submission unless required.
...
VALUES ('Custom'), ('Sport'), ('SUV'), ('Truck'), ('Used');
...
-- -----------------------------------------------------
-- 5. FINAL TASK UPDATES (Queries 4 & 6 from Task 1)
-- -----------------------------------------------------
